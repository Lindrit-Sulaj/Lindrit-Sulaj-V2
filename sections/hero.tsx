...
export default function Hero() {
  return (
    <section className='pt-20 pb-28 md:pt-28 md:pb-36 bg-palette-isabelline px-4 md:px-6'>
        ...
        <div className="w-full lg:w-3/5">
          ...
          <div className='mt-6 hidden md:flex items-center gap-3'>
            ...
            <ul className='flex gap-2'>
              <li>
                <a target="_blank" href="https://www.instagram.com/lindritsulaj" className='w-11 h-11 bg-neutral-900 text-white flex items-center justify-center rounded-full hover:bg-neutral-800 transition-all'>
                  <Instagram className='w-6 h-6' />
                </a>
              </li>
              <li>
                <a target="_blank" href="https://www.linkedin.com/in/lindrit-sulaj-0b75052b1/" className='w-11 h-11 bg-neutral-900 text-white flex items-center justify-center rounded-full hover:bg-neutral-800 transition-all'>
              ...
              <li>
                <a target="_blank" href="https://github.com/Lindrit-Sulaj" className='w-11 h-11 bg-neutral-900 text-white flex items-center justify-center rounded-full hover:bg-neutral-800 transition-all'>
