...
export default function Projects() {
  return (
    <section id="projects" className='max-w-screen-xl mx-auto px-4 my-10'>
      ...
      <div>
        <div className='flex items-center border rounded-xl border-neutral-300 mt-6'>
          <div className="w-3/5 p-10">
            <Badge className='bg-black'>Featured</Badge>
          ...
          <div className="w-2/5 flex justify-center bg-palette-orange">
            <img className='max-w-[500px]' src="https://ik.imagekit.io/0s9lwb2yr/Lindrit%20Sulaj/INOWEB_miQY8bd_j.png?updatedAt=1707328470050" alt="INOWEB Agentur" />
          </div>
        </div>
        <div className='flex items-center border rounded-xl border-neutral-300 mt-6'>
          <div className="w-3/5 p-10">
          ...
          <div className="w-2/5 flex justify-center bg-palette-orange">
            <img className='max-w-[500px]' src="https://ik.imagekit.io/0s9lwb2yr/Dream%20Design%20Project_l8labktde9.png?updatedAt=1707326568873" alt="Dream Design Website" />
          </div>
        </div>
        <div className='flex items-center border rounded-xl border-neutral-300 mt-6'>
          <div className="w-3/5 p-10">
          ...
          <div className="w-2/5 flex justify-center bg-palette-orange">
            <img className='max-w-[500px]' src="https://ik.imagekit.io/0s9lwb2yr/Pflasterbau%20Berisha_EFA94QSlP.png?updatedAt=1707327690666" alt="Pflasterbau Berisha" />
          </div>
        </div>
